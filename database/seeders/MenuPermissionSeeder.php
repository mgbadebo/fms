...
class MenuPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $menuPermissions = [
            ...
            // Production Cycles (New Structured Workflow)
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'production-cycles', 'permission_type' => 'view', 'name' => 'View Production Cycles', 'description' => 'View production cycles', 'sort_order' => 10],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'production-cycles', 'permission_type' => 'create', 'name' => 'Create Production Cycles', 'description' => 'Create new production cycles', 'sort_order' => 11],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'production-cycles', 'permission_type' => 'update', 'name' => 'Update Production Cycles', 'description' => 'Update existing production cycles', 'sort_order' => 12],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'daily-logs', 'permission_type' => 'view', 'name' => 'View Daily Logs', 'description' => 'View daily activity logs', 'sort_order' => 20],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'daily-logs', 'permission_type' => 'create', 'name' => 'Create Daily Logs', 'description' => 'Create new daily logs', 'sort_order' => 21],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'daily-logs', 'permission_type' => 'update', 'name' => 'Update Daily Logs', 'description' => 'Update existing daily logs', 'sort_order' => 22],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'daily-logs', 'permission_type' => 'submit', 'name' => 'Submit Daily Logs', 'description' => 'Submit daily logs', 'sort_order' => 23],
            ['menu_key' => 'admin', 'submenu_key' => 'activity-types', 'permission_type' => 'view', 'name' => 'View Activity Types', 'description' => 'View activity types', 'sort_order' => 110],
            ['menu_key' => 'admin', 'submenu_key' => 'activity-types', 'permission_type' => 'manage', 'name' => 'Manage Activity Types', 'description' => 'Create and manage activity types', 'sort_order' => 111],
            // Sales Module
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'view', 'name' => 'View Sales Orders', 'description' => 'View sales orders', 'sort_order' => 10],
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'create', 'name' => 'Create Sales Orders', 'description' => 'Create new sales orders', 'sort_order' => 11],
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'update', 'name' => 'Update Sales Orders', 'description' => 'Update existing sales orders', 'sort_order' => 12],
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'confirm', 'name' => 'Confirm Sales Orders', 'description' => 'Confirm sales orders', 'sort_order' => 13],
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'dispatch', 'name' => 'Dispatch Sales Orders', 'description' => 'Dispatch sales orders', 'sort_order' => 14],
            ['menu_key' => 'sales', 'submenu_key' => 'orders', 'permission_type' => 'cancel', 'name' => 'Cancel Sales Orders', 'description' => 'Cancel sales orders', 'sort_order' => 15],
            ['menu_key' => 'sales', 'submenu_key' => 'customers', 'permission_type' => 'manage', 'name' => 'Manage Customers', 'description' => 'Create and manage customers', 'sort_order' => 20],
            ['menu_key' => 'sales', 'submenu_key' => 'products', 'permission_type' => 'view', 'name' => 'View Products', 'description' => 'View products', 'sort_order' => 30],
            ['menu_key' => 'sales', 'submenu_key' => 'products', 'permission_type' => 'manage', 'name' => 'Manage Products', 'description' => 'Create and manage products', 'sort_order' => 31],
            ['menu_key' => 'sales', 'submenu_key' => 'kpis', 'permission_type' => 'view', 'name' => 'View Sales KPIs', 'description' => 'View sales and operational KPIs', 'sort_order' => 40],
            ['menu_key' => 'admin', 'submenu_key' => 'payments', 'permission_type' => 'record', 'name' => 'Record Payments', 'description' => 'Record payments for sales orders', 'sort_order' => 120],
            // Harvest Records
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'view', 'name' => 'View Harvest Records', 'description' => 'View harvest records', 'sort_order' => 10],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'create', 'name' => 'Create Harvest Records', 'description' => 'Create new harvest records', 'sort_order' => 11],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'update', 'name' => 'Update Harvest Records', 'description' => 'Update existing harvest records', 'sort_order' => 12],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'submit', 'name' => 'Submit Harvest Records', 'description' => 'Submit harvest records for approval', 'sort_order' => 13],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'approve', 'name' => 'Approve Harvest Records', 'description' => 'Approve submitted harvest records', 'sort_order' => 14],
            ['menu_key' => 'bell-pepper', 'submenu_key' => 'harvests', 'permission_type' => 'override_status', 'name' => 'Override Harvest Status', 'description' => 'Override harvest record status restrictions', 'sort_order' => 15],
            ...
            ['menu_key' => 'admin', 'submenu_key' => 'site-types', 'permission_type' => 'view', 'name' => 'View Site Types', 'description' => 'View site types', 'sort_order' => 145],
            ['menu_key' => 'admin', 'submenu_key' => 'site-types', 'permission_type' => 'create', 'name' => 'Create Site Types', 'description' => 'Create new site types', 'sort_order' => 146],
            ['menu_key' => 'admin', 'submenu_key' => 'site-types', 'permission_type' => 'update', 'name' => 'Update Site Types', 'description' => 'Update existing site types', 'sort_order' => 147],
